...
<div style="position: relative;">
    <span style="color: black; font-size: xx-large; font-weight:bold;">Edit Posted Job</span>
    <span style="float: right; font-size: large;" ><a href="/advertiser">home</a></span>

    <form:form method="post" action="/advertiser/job/${job.id}/edit" modelAttribute="job">
        <table style="width: 70%">
            ...
            <tr>
                <td colspan="2">
                    <span><a href="/advertiser/job/${job.id}/delete" class="delete-button">Delete</a> </span>
                    <span><a href="/advertiser" class="cancel-button">Cancel</a> </span>
                    <form:button style="margin-right: 30px">Submit</form:button>
                </td>
            </tr>
        </table>
    </form:form>
